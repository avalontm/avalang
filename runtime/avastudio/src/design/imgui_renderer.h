...
protected:
    ...
    void OnDrawLink(float x, float y,
                    ...
                    ComponentId compId,
                    const std::string& avaType) override;
    void OnDrawInput(float x, float y, float width, float height,
                     ...
                     ComponentId compId,
                     const std::string& avaType) override;
    void OnDrawCheckBox(float x, float y, float width, float height,
                        const std::string& text,
                        float fontSize, const char* fontName,
                        const Color& textColor,
                        ...
                        ComponentId compId,
                        const std::string& avaType) override;
    void OnDrawRadioButton(float x, float y, float width, float height,
                           const std::string& text,
                           float fontSize, const char* fontName,
                           const Color& textColor,
                           const Color& boxFillColor,
