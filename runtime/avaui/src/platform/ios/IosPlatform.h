...
class IosPlatform final : public IPlatform {
public:
...
private:
    ...
    stub::StubPlatformPaths paths_;
    stub::StubWheel wheel_;
    stub::StubTextInput textInput_;
    stub::StubTouch touch_;
    stub::StubIme ime_;
    stub::StubPlatformServices platformServices_;
};
