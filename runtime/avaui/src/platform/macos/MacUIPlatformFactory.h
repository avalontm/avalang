#ifndef AVA_UI_PLATFORM_MACOS_MACUIPLATFORMFACTORY_H
#define AVA_UI_PLATFORM_MACOS_MACUIPLATFORMFACTORY_H
...
// macOS backend. STUB -- en estudio / pausado a propósito (ver
...
class MacUIPlatformFactory final : public IUIPlatformFactory {
public:
...
#endif // AVA_UI_PLATFORM_MACOS_MACUIPLATFORMFACTORY_H
